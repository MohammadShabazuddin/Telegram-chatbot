...
async def welcome(message: types.Message):
    ...
    """
    await message.reply("Hi\nI am Tele Bot!\Created by Shabbu. How can i assist you?")
...
async def helper(message: types.Message):
    ...
    """
    help_command = """
    Hi There, I'm Telegram bot created by Shabbu! Please follow these commands - 
...
async def chatgpt(message: types.Message):
    ...
    try:
        response = openai.ChatCompletion.create(
            model=model_name,
            messages=[
                {"role": "assistant", "content": reference.response},  # Previous context
                {"role": "user", "content": message.text},  # User input
            ]
        )
